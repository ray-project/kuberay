...
class ClusterBuilder(IClusterBuilder):
    ...
    def build_meta(
        ...
        - ray_version (str, optional): The version of Ray to use for the cluster. Defaults to "2.6.0".
        """
    ...
    def build_head(
        self,
        ray_image: str = "rayproject/ray:2.6.0",
        ...
        Parameters:
        - ray_image (str): Docker image for the head node. Default value is "rayproject/ray:2.6.0".
    ...
    def build_worker(
        ...
        - ray_image (str, optional): Docker image for the Ray process. Default is "rayproject/ray:2.6.0".
