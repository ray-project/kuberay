...
import (
	...
	rayiv1 "github.com/ray-project/kuberay/ray-operator/pkg/client/clientset/versioned/typed/ray/v1"
...
// The default method implementations rely solely upon
func NewDefaultResourceManager(clientManager ClientManagerInterface) *DefaultResourceManager {
...
// Clients
func (r *DefaultResourceManager) getRayClusterClient(namespace string) rayiv1.RayClusterInterface {
	return r.clientManager.ClusterClient().RayClusterClient(namespace)
}

func (r *DefaultResourceManager) getRayJobClient(namespace string) rayiv1.RayJobInterface {
	return r.clientManager.JobClient().RayJobClient(namespace)
}

func (r *DefaultResourceManager) getRayServiceClient(namespace string) rayiv1.RayServiceInterface {
	return r.clientManager.ServiceClient().RayServiceClient(namespace)
}

func (r *DefaultResourceManager) getKubernetesConfigMapClient(namespace string) clientv1.ConfigMapInterface {
	return r.clientManager.KubernetesClient().ConfigMapClient(namespace)
}

func (r *DefaultResourceManager) getEventsClient(namespace string) clientv1.EventInterface {
	return r.clientManager.KubernetesClient().EventsClient(namespace)
}

func (r *DefaultResourceManager) getKubernetesNamespaceClient() clientv1.NamespaceInterface {
	return r.clientManager.KubernetesClient().NamespaceClient()
}

// clusters
func (r *DefaultResourceManager) CreateCluster(ctx context.Context, apiCluster *api.Cluster) (*rayv1api.RayCluster, error) {
	rayCluster, err := r.createRayCluster(ctx, apiCluster, nil)
	if err != nil {
		return nil, err
	}
	newRayCluster, err := r.getRayClusterClient(apiCluster.Namespace).Create(ctx, rayCluster, metav1.CreateOptions{})
	if err != nil {
...
func (r *DefaultResourceManager) createRayCluster(ctx context.Context, apiCluster *api.Cluster, additionalAnnotations map[string]string) (*rayv1api.RayCluster, error) {
	...
	for k, v := range additionalAnnotations {
		rayCluster.Annotations[k] = v
	}
	return rayCluster.Get(), nil
}

// Compute template
func (r *DefaultResourceManager) populateComputeTemplate(ctx context.Context, clusterSpec *api.ClusterSpec, nameSpace string) (map[string]*api.ComputeTemplate, error) {
...
func (r *DefaultResourceManager) GetCluster(ctx context.Context, clusterName string, namespace string) (*rayv1api.RayCluster, error) {
	client := r.getRayClusterClient(namespace)
	return getClusterByName(ctx, client, clusterName)
}

func (r *DefaultResourceManager) ListClusters(ctx context.Context, namespace string) ([]*rayv1api.RayCluster, error) {
...
func (r *DefaultResourceManager) ListAllClusters(ctx context.Context) ([]*rayv1api.RayCluster, error) {
...
func (r *DefaultResourceManager) DeleteCluster(ctx context.Context, clusterName string, namespace string) error {
	client := r.getRayClusterClient(namespace)
...
func (r *DefaultResourceManager) CreateJob(ctx context.Context, apiJob *api.RayJob) (*rayv1api.RayJob, error) {
	rayJob, err := r.createRayJob(ctx, apiJob, nil)
	if err != nil {
		return nil, util.NewInternalServerError(err, "Failed to create a job CRD for (%s/%s)", apiJob.Namespace, apiJob.JobId)
	}
...
func (r *DefaultResourceManager) createRayJob(ctx context.Context, apiJob *api.RayJob, additionalAnnotations map[string]string) (*util.RayJob, error) {
	...
	// convert *api.Cluster to v1.RayCluster
...
func (r *DefaultResourceManager) GetJob(ctx context.Context, jobName string, namespace string) (*rayv1api.RayJob, error) {
	client := r.getRayJobClient(namespace)
	return getJobByName(ctx, client, jobName)
}

func (r *DefaultResourceManager) ListJobs(ctx context.Context, namespace string) ([]*rayv1api.RayJob, error) {
	labelSelector := metav1.LabelSelector{
		MatchLabels: map[string]string{
			util.KubernetesManagedByLabelKey: util.ComponentName,
		},
...
func (r *DefaultResourceManager) ListAllJobs(ctx context.Context) ([]*rayv1api.RayJob, error) {
	namespaces, err := r.getKubernetesNamespaceClient().List(ctx, metav1.ListOptions{})
	if err != nil {
		return nil, util.Wrap(err, "Failed to fetch all Kubernetes namespaces")
	}
...
func (r *DefaultResourceManager) DeleteJob(ctx context.Context, jobName string, namespace string) error {
	client := r.getRayJobClient(namespace)
...
func (r *DefaultResourceManager) CreateService(ctx context.Context, apiService *api.RayService) (*rayv1api.RayService, error) {
	// populate cluster map
...
func (r *DefaultResourceManager) UpdateRayService(ctx context.Context, apiService *api.RayService) (*rayv1api.RayService, error) {
...
func (r *DefaultResourceManager) GetService(ctx context.Context, serviceName, namespace string) (*rayv1api.RayService, error) {
	client := r.getRayServiceClient(namespace)
	return getServiceByName(ctx, client, serviceName)
}

func (r *DefaultResourceManager) ListServices(ctx context.Context, namespace string) ([]*rayv1api.RayService, error) {
	labelSelector := metav1.LabelSelector{
		MatchLabels: map[string]string{
			util.KubernetesManagedByLabelKey: util.ComponentName,
		},
...
func (r *DefaultResourceManager) ListAllServices(ctx context.Context) ([]*rayv1api.RayService, error) {
	rayServices := make([]*rayv1api.RayService, 0)
...
func (r *DefaultResourceManager) DeleteService(ctx context.Context, serviceName, namespace string) error {
	client := r.getRayServiceClient(namespace)
...
// Compute Runtimes
func (r *DefaultResourceManager) CreateComputeTemplate(ctx context.Context, runtime *api.ComputeTemplate) (*v1.ConfigMap, error) {
...
func (r *DefaultResourceManager) GetComputeTemplate(ctx context.Context, name string, namespace string) (*v1.ConfigMap, error) {
	client := r.getKubernetesConfigMapClient(namespace)
	return getComputeTemplateByName(ctx, client, name)
}

func (r *DefaultResourceManager) ListComputeTemplates(ctx context.Context, namespace string) ([]*v1.ConfigMap, error) {
	client := r.getKubernetesConfigMapClient(namespace)
...
func (r *DefaultResourceManager) ListAllComputeTemplates(ctx context.Context) ([]*v1.ConfigMap, error) {
	namespaces, err := r.getKubernetesNamespaceClient().List(ctx, metav1.ListOptions{})
	if err != nil {
		return nil, util.Wrap(err, "Failed to fetch all Kubernetes namespaces")
	}
...
func (r *DefaultResourceManager) DeleteComputeTemplate(ctx context.Context, name string, namespace string) error {
	client := r.getKubernetesConfigMapClient(namespace)
...
func getClusterByName(ctx context.Context, client rayiv1.RayClusterInterface, name string) (*rayv1api.RayCluster, error) {
...
func getJobByName(ctx context.Context, client rayiv1.RayJobInterface, name string) (*rayv1api.RayJob, error) {
...
func getServiceByName(ctx context.Context, client rayiv1.RayServiceInterface, name string) (*rayv1api.RayService, error) {
...
func (r *DefaultResourceManager) GetClusterEvents(ctx context.Context, clusterName string, namespace string) ([]v1.Event, error) {
...
func getRayClusterEventsByName(ctx context.Context, name string, client clientv1.EventInterface, clusterClient rayiv1.RayClusterInterface) ([]v1.Event, error) {
...
func (r *DefaultResourceManager) GetServiceEvents(ctx context.Context, service rayv1api.RayService) ([]v1.Event, error) {
