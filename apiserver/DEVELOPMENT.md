...
* `E2E_API_SERVER_RAY_IMAGE` -- for the ray docker image. Currently set to `rayproject/ray:2.8.1-py310`. On Apple silicon or arm64 development machines the `-aarch64` suffix is added to the image.
