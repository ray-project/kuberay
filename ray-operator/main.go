...
import (
	...
	rayv1beta1 "github.com/ray-project/kuberay/ray-operator/apis/ray/v1beta1"
...
func init() {
	...
	utilruntime.Must(rayv1beta1.AddToScheme(scheme))
...
func main() {
	...
	if err = (&rayv1alpha1.RayCluster{}).SetupWebhookWithManager(mgr); err != nil {
