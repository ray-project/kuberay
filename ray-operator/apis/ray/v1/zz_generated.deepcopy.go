...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IngressOptionsStruct) DeepCopyInto(out *IngressOptionsStruct) {
	*out = *in
	if in.Ingresses != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IngressOptionsStruct.
func (in *IngressOptionsStruct) DeepCopy() *IngressOptionsStruct {
	if in == nil {
		return nil
	}
	out := new(IngressOptionsStruct)
	in.DeepCopyInto(out)
	return out
}
