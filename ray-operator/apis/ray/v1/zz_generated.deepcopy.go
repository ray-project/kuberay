...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GcsReadyOptions) DeepCopyInto(out *GcsReadyOptions) {
	*out = *in
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
		*out = new(corev1.ResourceRequirements)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GcsReadyOptions.
func (in *GcsReadyOptions) DeepCopy() *GcsReadyOptions {
	if in == nil {
		return nil
	}
	out := new(GcsReadyOptions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RayClusterSpec) DeepCopyInto(out *RayClusterSpec) {
	*out = *in
	...
	if in.GcsReadyOptions != nil {
		in, out := &in.GcsReadyOptions, &out.GcsReadyOptions
		*out = new(GcsReadyOptions)
		(*in).DeepCopyInto(*out)
	}
