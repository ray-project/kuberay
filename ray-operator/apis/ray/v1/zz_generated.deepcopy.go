...
func (in *RayJobSpec) DeepCopyInto(out *RayJobSpec) {
	*out = *in
	...
	if in.SubmitterFinishedTimeoutSeconds != nil {
		in, out := &in.SubmitterFinishedTimeoutSeconds, &out.SubmitterFinishedTimeoutSeconds
		*out = new(int32)
		**out = **in
	}
}
...
func (in *RayJobStatus) DeepCopyInto(out *RayJobStatus) {
	*out = *in
	...
	if in.SubmitterFinishedTime != nil {
		in, out := &in.SubmitterFinishedTime, &out.SubmitterFinishedTime
		*out = (*in).DeepCopy()
	}
}
