...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodFQDNOptions) DeepCopyInto(out *PodFQDNOptions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodFQDNOptions.
func (in *PodFQDNOptions) DeepCopy() *PodFQDNOptions {
	if in == nil {
		return nil
	}
	out := new(PodFQDNOptions)
	in.DeepCopyInto(out)
	return out
}
