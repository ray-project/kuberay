...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HistoryServerCollectorOptions) DeepCopyInto(out *HistoryServerCollectorOptions) {
	*out = *in
	if in.Image != nil {
		in, out := &in.Image, &out.Image
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HistoryServerCollectorOptions.
func (in *HistoryServerCollectorOptions) DeepCopy() *HistoryServerCollectorOptions {
	if in == nil {
		return nil
	}
	out := new(HistoryServerCollectorOptions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RayClusterSpec) DeepCopyInto(out *RayClusterSpec) {
	*out = *in
	...
	if in.HistoryServerCollector != nil {
		in, out := &in.HistoryServerCollector, &out.HistoryServerCollector
		*out = new(HistoryServerCollectorOptions)
		(*in).DeepCopyInto(*out)
	}
