...
func (in *GcsFaultToleranceOptions) DeepCopyInto(out *GcsFaultToleranceOptions) {
	*out = *in
	...
	if in.EnableActivePassiveHead != nil {
		in, out := &in.EnableActivePassiveHead, &out.EnableActivePassiveHead
		*out = new(bool)
		**out = **in
	}
	if in.LeaderElectionLeaseDurationSeconds != nil {
		in, out := &in.LeaderElectionLeaseDurationSeconds, &out.LeaderElectionLeaseDurationSeconds
		*out = new(int32)
		**out = **in
	}
	if in.LeaderElectionRenewDeadlineSeconds != nil {
		in, out := &in.LeaderElectionRenewDeadlineSeconds, &out.LeaderElectionRenewDeadlineSeconds
		*out = new(int32)
		**out = **in
	}
	if in.LeaderElectionRetryPeriodSeconds != nil {
		in, out := &in.LeaderElectionRetryPeriodSeconds, &out.LeaderElectionRetryPeriodSeconds
		*out = new(int32)
		**out = **in
	}
}
