...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IdleTerminationOptions) DeepCopyInto(out *IdleTerminationOptions) {
	*out = *in
	if in.Policy != nil {
		in, out := &in.Policy, &out.Policy
		*out = new(IdleTerminationPolicy)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IdleTerminationOptions.
func (in *IdleTerminationOptions) DeepCopy() *IdleTerminationOptions {
	if in == nil {
		return nil
	}
	out := new(IdleTerminationOptions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RayClusterSpec) DeepCopyInto(out *RayClusterSpec) {
	*out = *in
	...
	if in.IdleSuspend != nil {
		in, out := &in.IdleSuspend, &out.IdleSuspend
		*out = new(bool)
		**out = **in
	}
	if in.IdleTerminationOptions != nil {
		in, out := &in.IdleTerminationOptions, &out.IdleTerminationOptions
		*out = new(IdleTerminationOptions)
		(*in).DeepCopyInto(*out)
	}
	if in.ManagedBy != nil {
