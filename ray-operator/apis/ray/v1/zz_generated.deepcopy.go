...
func (in *RayServiceSpec) DeepCopyInto(out *RayServiceSpec) {
	*out = *in
	...
	if in.UpgradeSpec != nil {
		in, out := &in.UpgradeSpec, &out.UpgradeSpec
		*out = new(RayServiceUpgradeSpec)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RayServiceUpgradeSpec) DeepCopyInto(out *RayServiceUpgradeSpec) {
	*out = *in
	if in.Type != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RayServiceUpgradeSpec.
func (in *RayServiceUpgradeSpec) DeepCopy() *RayServiceUpgradeSpec {
	if in == nil {
		return nil
	}
	out := new(RayServiceUpgradeSpec)
