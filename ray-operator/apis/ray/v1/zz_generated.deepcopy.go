...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RayClusterWebhook) DeepCopyInto(out *RayClusterWebhook) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RayClusterWebhook.
func (in *RayClusterWebhook) DeepCopy() *RayClusterWebhook {
	if in == nil {
		return nil
	}
	out := new(RayClusterWebhook)
	in.DeepCopyInto(out)
	return out
}
