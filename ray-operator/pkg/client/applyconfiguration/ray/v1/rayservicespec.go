...
type RayServiceSpecApplyConfiguration struct {
	...
	UpgradeStrategy                    *rayv1.UpgradeStrategy            `json:"upgradeStrategy,omitempty"`
...
func (b *RayServiceSpecApplyConfiguration) WithUpgradeStrategy(value rayv1.UpgradeStrategy) *RayServiceSpecApplyConfiguration {
