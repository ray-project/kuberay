...
type DeletionRuleApplyConfiguration struct {
	Resource  *rayv1.DeletionPolicyType            `json:"resource,omitempty"`
...
func (b *DeletionRuleApplyConfiguration) WithResource(value rayv1.DeletionPolicyType) *DeletionRuleApplyConfiguration {
	b.Resource = &value
	return b
}
