...
type AutoscalerOptionsApplyConfiguration struct {
	...
	Version            *rayv1.Version               `json:"version,omitempty"`
...
func (b *AutoscalerOptionsApplyConfiguration) WithVersion(value rayv1.Version) *AutoscalerOptionsApplyConfiguration {
	b.Version = &value
	return b
}
