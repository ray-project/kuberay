...
func (r *RayClusterReconciler) reconcilePods(ctx context.Context, instance *rayv1.RayCluster) error {
	...
	if !r.rayClusterScaleExpectation.IsSatisfied(ctx, instance.Namespace, instance.Name, expectations.HeadGroup) {
		...
		if creatorCRDType == utils.RayClusterCRD {
			common.CreatedClustersCounterInc(instance.Namespace, false, false)
		} else if creatorCRDType == utils.RayJobCRD {
			common.CreatedClustersCounterInc(instance.Namespace, true, false)
		} else if creatorCRDType == utils.RayServiceCRD {
			common.CreatedClustersCounterInc(instance.Namespace, false, true)
		}
