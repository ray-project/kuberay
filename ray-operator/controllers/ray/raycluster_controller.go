...
// Uses the cached IsOpenShift value from reconciler options instead of querying the API.
func (r *RayClusterReconciler) shouldCreateRoute() bool {
	return r.options.IsOpenShift && !utils.ShouldUseIngressOnOpenShift()
}
