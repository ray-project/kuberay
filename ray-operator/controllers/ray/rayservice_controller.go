...
func (r *RayServiceReconciler) cleanUpRayClusterInstance(ctx context.Context, rayServiceInstance *rayv1.RayService) error {
	...
	if rayServiceInstance.Spec.RayClusterDeletionDelaySeconds != nil {
		if *rayServiceInstance.Spec.RayClusterDeletionDelaySeconds < 0 {
			...
			logger.Info("RayClusterDeletionDelaySeconds is set correctly and will be used.", "RayClusterDeletionDelaySeconds", *rayServiceInstance.Spec.RayClusterDeletionDelaySeconds)
