...
//
//	mockgen -destination=controllers/ray/metrics/mocks/ray_cluster_metrics_mock.go -package=mocks github.com/ray-project/kuberay/ray-operator/controllers/ray/metrics RayClusterMetricsObserver
//
...
func (m *MockRayClusterMetricsObserver) ObserveRayClusterProvisionedDuration(name, namespace string, uid types.UID, duration float64) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ObserveRayClusterProvisionedDuration", name, namespace, uid, duration)
}
...
func (mr *MockRayClusterMetricsObserverMockRecorder) ObserveRayClusterProvisionedDuration(name, namespace, uid, duration any) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ObserveRayClusterProvisionedDuration", reflect.TypeOf((*MockRayClusterMetricsObserver)(nil).ObserveRayClusterProvisionedDuration), name, namespace, uid, duration)
}
