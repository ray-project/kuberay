...
//
//	mockgen -destination=controllers/ray/metrics/mocks/ray_job_metrics_mock.go -package=mocks github.com/ray-project/kuberay/ray-operator/controllers/ray/metrics RayJobMetricsObserver
//
...
func (m *MockRayJobMetricsObserver) ObserveRayJobExecutionDuration(name, namespace string, uid types.UID, jobDeploymentStatus v1.JobDeploymentStatus, retryCount int, duration float64) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ObserveRayJobExecutionDuration", name, namespace, uid, jobDeploymentStatus, retryCount, duration)
}
...
func (mr *MockRayJobMetricsObserverMockRecorder) ObserveRayJobExecutionDuration(name, namespace, uid, jobDeploymentStatus, retryCount, duration any) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ObserveRayJobExecutionDuration", reflect.TypeOf((*MockRayJobMetricsObserver)(nil).ObserveRayJobExecutionDuration), name, namespace, uid, jobDeploymentStatus, retryCount, duration)
}
