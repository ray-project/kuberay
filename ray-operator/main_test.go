...
`,
			expectedConfig: configapi.Configuration{
				...
				AsyncJobInfoQueryInterval:    "3s",
				AsyncJobInfoQueryWorkerSize:  8,
				AsyncJobInfoQueryCacheExpiry: "10m",
			},
			expectErr: false,
		},
		{
...
`,
		...
		{
			name: "Set AsyncJobInfoQuery fields",
			configData: `apiVersion: config.ray.io/v1alpha1
kind: Configuration
metricsAddr: ":8080"
probeAddr: ":8082"
enableLeaderElection: true
reconcileConcurrency: 100
asyncJobInfoQueryInterval: 5s
asyncJobInfoQueryWorkerSize: 16
asyncJobInfoQueryCacheExpiry: 15m
`,
			expectedConfig: configapi.Configuration{
				TypeMeta: metav1.TypeMeta{
					Kind:       "Configuration",
