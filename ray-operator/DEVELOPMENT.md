...
* Step2: You must be in `/path/to/your/kuberay/`.
  ...
  # [Example]:
  RAY_IMAGE=rayproject/ray:2.9.1 OPERATOR_IMAGE=kuberay/operator:nightly python3 tests/compatibility-test.py
  ```
...
RAY_IMAGE=rayproject/ray:2.9.1 OPERATOR_IMAGE=kuberay/operator:nightly python3 tests/test_sample_raycluster_yamls.py
# Test RayService doc examples.
RAY_IMAGE=rayproject/ray:2.9.1 OPERATOR_IMAGE=kuberay/operator:nightly python3 tests/test_sample_rayservice_yamls.py
```
