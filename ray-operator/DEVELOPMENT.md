...
Currently, KubeRay uses go v1.21 for development.
...
Download gofumpt version **0.5.0**. At the time of writing, v0.5.0 is the latest version compatible with go1.21. Run this command to download it:
