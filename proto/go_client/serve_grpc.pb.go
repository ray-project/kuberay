...
type RayServeServiceClient interface {
	...
	CreateRayServe(ctx context.Context, in *CreateRayServiceRequest, opts ...grpc.CallOption) (*RayService, error)
...
func (c *rayServeServiceClient) CreateRayServe(ctx context.Context, in *CreateRayServiceRequest, opts ...grpc.CallOption) (*RayService, error) {
	out := new(RayService)
	err := c.cc.Invoke(ctx, "/proto.RayServeService/CreateRayServe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RayServeServiceServer interface {
	// Create a new ray serve.
	CreateRayServe(context.Context, *CreateRayServiceRequest) (*RayService, error)
	// Find a specific ray serve by name and namespace.
...
func (UnimplementedRayServeServiceServer) CreateRayServe(context.Context, *CreateRayServiceRequest) (*RayService, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateRayServe not implemented")
}
...
func _RayServeService_CreateRayServe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateRayServiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RayServeServiceServer).CreateRayServe(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.RayServeService/CreateRayServe",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RayServeServiceServer).CreateRayServe(ctx, req.(*CreateRayServiceRequest))
	}
...
var RayServeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateRayServe",
			Handler:    _RayServeService_CreateRayServe_Handler,
		},
		{
