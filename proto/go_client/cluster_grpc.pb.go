...
const (
	...
	ClusterService_ListCluster_FullMethodName     = "/proto.ClusterService/ListCluster"
	ClusterService_ListAllClusters_FullMethodName = "/proto.ClusterService/ListAllClusters"
	ClusterService_DeleteCluster_FullMethodName   = "/proto.ClusterService/DeleteCluster"
)
...
func (c *clusterServiceClient) ListCluster(ctx context.Context, in *ListClustersRequest, opts ...grpc.CallOption) (*ListClustersResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClusterService_ListCluster_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterServiceClient) ListAllClusters(ctx context.Context, in *ListAllClustersRequest, opts ...grpc.CallOption) (*ListAllClustersResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClusterService_ListAllClusters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ClusterService_ListCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClusterService_ListCluster_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClusterService_ListAllClusters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClusterService_ListAllClusters_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
