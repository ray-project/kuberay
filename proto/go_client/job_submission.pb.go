...
func (x *JobSubmissionInfo) GetStartTime() int64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *JobSubmissionInfo) GetEndTime() int64 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
var file_job_submission_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x42, 0x0a, 0x08, 0x6d,
