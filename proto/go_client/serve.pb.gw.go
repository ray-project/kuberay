...
var (
	filter_RayServeService_CreateRayServe_0 = &utilities.DoubleArray{Encoding: map[string]int{"service": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_RayServeService_CreateRayServe_0(ctx context.Context, marshaler runtime.Marshaler, client RayServeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_RayServeService_CreateRayServe_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.CreateRayServe(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_RayServeService_CreateRayServe_0(ctx context.Context, marshaler runtime.Marshaler, server RayServeServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateRayServiceRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CreateRayServe(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterRayServeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RayServeServiceServer) error {
	...
	mux.Handle("POST", pattern_RayServeService_CreateRayServe_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.RayServeService/CreateRayServe", runtime.WithHTTPPathPattern("/apis/v1alpha2/services"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_RayServeService_CreateRayServe_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_RayServeService_CreateRayServe_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterRayServeServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RayServeServiceClient) error {
	...
	mux.Handle("POST", pattern_RayServeService_CreateRayServe_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/proto.RayServeService/CreateRayServe", runtime.WithHTTPPathPattern("/apis/v1alpha2/services"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_RayServeService_CreateRayServe_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_RayServeService_CreateRayServe_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"apis", "v1alpha2", "services"}, ""))
...
var (
	forward_RayServeService_CreateRayServe_0 = runtime.ForwardResponseMessage
