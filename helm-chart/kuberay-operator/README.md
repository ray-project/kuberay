...
| asyncJobInfoQuery | bool | `false` | When AsyncJobInfoQuery is set to true:    the KubeRay operator will use background goroutines to fetch the jobInfo from Ray clusters for RayJob status updates. |
