...
type StorageReader interface {
	...
	//
	// clusterStoragePrefix is the RayCluster's storage prefix following the format:
	// "{namespace}/{name}"
	GetContent(clusterStoragePrefix string, fileName string) io.Reader

	ListFiles(clusterStoragePrefix string, dir string) []string
}
