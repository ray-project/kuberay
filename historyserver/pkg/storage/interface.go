...
type StorageReader interface {
	...
	List(ctx context.Context) []utils.ClusterInfo
	...
	//
	GetContent(ctx context.Context, clusterId string, fileName string) io.Reader

	ListFiles(ctx context.Context, clusterId string, dir string) []string
}
