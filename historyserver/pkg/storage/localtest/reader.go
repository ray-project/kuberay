...
func (r *MockReader) GetContent(clusterNameNamespace string, fileName string) io.Reader {
	if clusterData, ok := r.data[clusterNameNamespace]; ok {
...
func (r *MockReader) ListFiles(clusterNameNamespace string, dir string) []string {
	if clusterData, ok := r.data[clusterNameNamespace]; ok {
