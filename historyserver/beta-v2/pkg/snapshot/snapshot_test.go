...
// verifies the snapshot survives a JSON roundtrip intact. We only set the
// minimal identifying fields per type — this test is about map carriage, not
// deep field coverage (types themselves have their own tests in v1).
